...
contract('ReportManager', accounts => {
  ...
  const hashDocValid = '0x000000000000000000000000000000000000000086f7e437faa5a7fce15d1ddcb9eaeaea377667b8'
  let reportManager
